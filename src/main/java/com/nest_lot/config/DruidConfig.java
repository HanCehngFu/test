...
@MapperScan("com.nest_lot.dao.mapper")
public class DruidConfig implements TransactionManagementConfigurer {
	...
	private final static String XMLMAPPER = "classpath:mapperXml/**Mapper.xml";
	...
	public SqlSessionFactoryBean createSqlSessionFactoryBean() throws Exception {
		...
		sqlSessionFactoryBean.setMapperLocations(resolver.getResources(XMLMAPPER));
