...
public class HttpClientUtils {
	 ...
	 * @create 2015年12月18日
	 */
	public static CloseableHttpClient getHttpClient(CloseableHttpClient httpClient_a, String url) {
		...
		if (httpClient_a == null) {
			synchronized (syncLock) {
				if (httpClient_a == null) {
					httpClient_a = createHttpClient(200, 40, 100, hostname, port);
				}
			}
		}
		return httpClient_a;
	...
	public static void main(String[] args) {
		// URL列表数组
		String[] urisToGet = { "http://blog.csdn.net/catoop/article/details/38849497", "http://blog.csdn.net/catoop/article/details/38849497",
		...
		try {
			...
			System.out.println("线程" + Thread.currentThread().getName() + "," + System.currentTimeMillis() + ", 全部线程已完毕。開始进入下一步！");
		}
